<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EmployeeThirdEducation.aspx.vb" Inherits="GOSHRM.EmployeeThirdEducation" EnableEventValidation="true" %>
...
<body onunload="window.opener.location=window.opener.location;" style="height: 317px">
    ...
    <table>
        ...
        <tr>
            <td class="style3">
                ID <span class="style7">*</span>
            </td>
            <td class="style4">
                <asp:TextBox ID="txtEmpID" runat="server" Width="10%" Style="font-size: small;
                    font-family: Candara" BorderColor="#CCCCCC" BorderStyle="None" 
        ...
        <tr>
            <td class="style10">
                <span class="style9">Qualification</span><span class="style8"> </span> <span class="style7">*</span></td>
            <td >
                <telerik:RadDropDownList ID="radQualification" runat="server" 
        ...
        <tr>
            <td class="style10">
                <span class="style8">Start Date </span> <span class="style7">*</span></td>
            <td>
               <table width="100%">
               <tr>
               <td class="style99">
                   <telerik:RadComboBox ID="radStartDate" Runat="server">
                   </telerik:RadComboBox>
               </td>
               <td>
                   <telerik:RadComboBox ID="radStartYear" Runat="server">
                   </telerik:RadComboBox>
               </td>
               <td>
                   &nbsp;</td>
        ...
        <tr>
            <td class="style10">
                <span class="style9">Completed O</span><span class="style8">n </span> <span class="style7">*</span></td>
            <td>
               <table width="100%">
               <tr>
               <td class="style99">
                   <telerik:RadComboBox ID="radEndDate" Runat="server" AutoPostBack="True">
                   </telerik:RadComboBox>
               </td>
               <td>
                   <telerik:RadComboBox ID="radEndYear" Runat="server" style="margin-left: 0px">
                   </telerik:RadComboBox>
               </td>
               <td>
                   &nbsp;</td>
