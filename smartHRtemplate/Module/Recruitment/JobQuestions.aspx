  ...
  <%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="JobQuestions.aspx.vb"
    Inherits="GOSHRM.JobQuestions" EnableEventValidation="false" Debug="true" %>
         ...
         <div class="panel panel-success">
                <div class="panel-heading">
                   <h5 id="pagetitle" runat="server" class="page-title" style="color: #1BA691">
                    Head</h5>              
                <asp:TextBox ID="txtID" runat="server" Visible="False" Font-Size="1px"  
        ...
        <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="CSV File (Comma Delimited): question, questiontype, ordering,answer, optionA, optionB, optionC,optionD" style="margin-right:10px;margin-left:10px;height:35px"></button>
            ...
            <div class="table-responsive">
                        <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Question" ItemStyle-Font-Bold="true" SortExpression="Question">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Recruitment/JobQuestionsUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("Question")%>' /></ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="ordering" HeaderText="Ordering" SortExpression="ordering" ItemStyle-HorizontalAlign="Right"  />                                           
                            </Columns>
