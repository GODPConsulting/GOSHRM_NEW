...
public class ImgHandler : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            selcmd = new System.Data.SqlClient.SqlCommand("select isnull(imgfile,'') imgfile, isnull(imgtype,'') imgtype from Emp_PersonalDetail where id=" + context.Request.QueryString["imgid"], conn);
          conn.Open();
