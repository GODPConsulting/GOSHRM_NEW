<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EmployeeThirdLanguage.aspx.vb" Inherits="GOSHRM.EmployeeThirdLanguage" EnableEventValidation="true" %>
    ...
    <table>
        ...
        <tr>
            <td class="style3">
                &nbsp;</td>
            <td class="style4">
                <asp:TextBox ID="txtEmpID" runat="server" Width="4px" Style="font-size: small;
                    font-family: Candara" Enabled="False" Height="10px" Visible="False"></asp:TextBox>
            </td>
        </tr>
       
        <tr>
            <td>
                <span class="style8">Language </span> <span class="style7">*</span></td>
            <td>
                <telerik:RadDropDownList ID="radLanguage" runat="server" 
        ...
        <tr>
            <td>
                <span class="style9">Reading Level </span> <span class="style7">*</span></td>
            <td>
                <telerik:RadDropDownList ID="radRead" runat="server" 
                    DefaultMessage="-- Select --" Font-Names="Candara" Font-Size="Medium" 
            Height="16px" Width="443px" style="font-size: small">
                </telerik:RadDropDownList>
        ...
        <tr>
            <td>
                <span class="style9">Writing Level</span><span class="style8"> </span> <span class="style7">*</span></td>
            <td>
                <telerik:RadDropDownList ID="radWrite" runat="server" 
                    DefaultMessage="-- Select --" Font-Names="Candara" Font-Size="Medium" 
            Height="16px" Width="443px" style="font-size: small">
                </telerik:RadDropDownList>
        ...
        <tr>
            <td>
                <span class="style9">Speaking Level</span><span class="style8"> </span> <span class="style7">*</span></td>
            <td>
                <telerik:RadDropDownList ID="radSpeak" runat="server" 
                    DefaultMessage="-- Select --" Font-Names="Candara" Font-Size="Medium" 
            Height="16px" Width="443px" style="font-size: small">
                </telerik:RadDropDownList>
        ...
        <tr>
            <td>
                <asp:Button ID="btnAdd" runat="server" Text="Save" BackColor="#1BA691" ForeColor="White"
                    Width="120px" Height="30px" BorderStyle="Ridge" />
            </td>
            <td>
