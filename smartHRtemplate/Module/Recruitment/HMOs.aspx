<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="HMOs.aspx.vb"
    Inherits="GOSHRM.HMOs" EnableEventValidation="false" Debug="true" %>
          ...
          <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="CSV File: HMOCode, HMOName, Address, Contact Person, Contact Number, Registration Dateo" style="margin-right:10px;margin-left:10px;height:35px"></button>
        ...
        <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Code"  ItemStyle-Font-Bold="true"
                            SortExpression="HMOCode">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Recruitment/HMOsUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("HMOCode")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                         <asp:BoundField DataField="HMO" HeaderText="Name" SortExpression="hmo" />
                        ...
                        <asp:BoundField DataField="RegistrationDate" HeaderText="Registration Date" SortExpression ="RegistrationDate" DataFormatString="{0:dd, MMM yyyy}" />         
                    </Columns>
