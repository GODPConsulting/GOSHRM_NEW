<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WorkForceMoveBudget.aspx.vb"
    Inherits="GOSHRM.WorkForceMoveBudget" EnableEventValidation="false" %>
...
<body onunload="window.opener.location=window.opener.location;" style="height: 317px">
    ...
    <table>
        ...
        <tr>
            <td valign="top" class="style6" style="font-family: Verdana; font-size: 11px" 
                colspan="2">
                    
                    <asp:Label ID="lblCompany" runat="server" CssClass="lbl" Font-Names="Verdana"
                        Font-Size="13px" Font-Bold="True" ForeColor="#666666"></asp:Label>
        ...
        <tr>
            <td valign="top" class="style6" style="font-family: Verdana; font-size: 11px">
                    ...
                    <asp:Label ID="lblBudget0" runat="server" CssClass="lbl" Font-Names="Verdana"
                        Font-Size="12px" Font-Bold="True" ForeColor="#666666">Current Budget</asp:Label>
                    
            </td>
            <td class="style8">
                    
                    <asp:Label ID="lblBudget" runat="server" CssClass="lbl" Font-Names="Verdana"
        ...
        <tr>
            <td class="style6" style="font-family: Verdana; font-size: 11px">
                    
                    <asp:Label ID="lblBudget1" runat="server" CssClass="lbl" Font-Names="Verdana"
                        Font-Size="12px" Font-Bold="True" ForeColor="#666666">Next Budget</asp:Label>
            ...
            <td class="style8">
                    ...
                    ResolvedRenderMode="Classic" Width="150px" ID="cboNewBudget" Font-Names="Verdana" Font-Size="12px" 
                                                ForeColor="#666666"><Items>
...
<telerik:RadComboBoxItem runat="server" Text="December" Value="12" Owner="cboNewBudget"></telerik:RadComboBoxItem>
        ...
        <tr>
            <td class="style6">
                <asp:Button ID="btnAdd" runat="server" Text="Start Copy" BackColor="#1BA691" ForeColor="White"
                    Width="120px" Height="20px" BorderStyle="None" Font-Names="Verdana" 
                    Font-Size="12px" onclientclick="Confirm()" />
            </td>
            <td class="style8">
