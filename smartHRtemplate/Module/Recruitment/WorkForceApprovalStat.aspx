<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WorkForceApprovalStat.aspx.vb"
    Inherits="GOSHRM.WorkForceApprovalStat" EnableEventValidation="false" %>
    ...
    <div class="container">
        <div class="row">
            <div id="divalert" runat="server" visible="false" class="alert alert-info">
                ...
                <asp:Label ID="lblbudget" runat="server" Font-Size="1px" Visible="False"></asp:Label>
                <asp:Label ID="lbldept" runat="server" Font-Size="1px" Visible="False"></asp:Label>
                                ...
                                <div class=" col-md-8">
                                    <div class="form-group">
                                        ...
                                        <telerik:radcombobox runat="server" resolvedrendermode="Classic" forecolor="#666666"
                                            id="cboApprover1" filter="Contains" width="100%" rendermode="Lightweight" skin="Bootstrap">
                                        </telerik:radcombobox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class=" col-md-8">
                                    <div class="form-group">
                                        <label>
                                            NAME</label>
                                        <telerik:radcombobox runat="server" resolvedrendermode="Classic" forecolor="#666666" autopostback="true"
                                            id="cboApprover2" filter="Contains" width="100%" rendermode="Lightweight" skin="Bootstrap">
                                        </telerik:radcombobox>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class=" col-md-8">
                                    <div class="form-group">
                                        <label>
                                            NAME</label>
                                        <telerik:radcombobox runat="server" resolvedrendermode="Classic" forecolor="#666666" autopostback="true"
                                            id="cboApprover3" filter="Contains" width="100%" rendermode="Lightweight" skin="Bootstrap">
                                        </telerik:radcombobox>
                                    </div>
                                </div>
                            </div>
                            <div id="divapprover3" runat="server">
                                <div class="row">
                                    <div class=" col-md-8">
                                        <div class="form-group">
                                            <label>
                                ...
                                <div class=" col-md-8">
                                    <div class="form-group">
                                        <label>
                                            NAME</label>
                                        <telerik:radcombobox runat="server" resolvedrendermode="Classic" forecolor="#666666" autopostback="true"
                                            id="cboApprover4" filter="Contains" width="100%" rendermode="Lightweight" skin="Bootstrap">
                                        </telerik:radcombobox>
                                    </div>
                                </div>
                            </div>
                            <div id="divapprover4" runat="server">
                                <div class="row">
                                    <div class=" col-md-8">
                                        <div class="form-group">
                                            <label>
        ...
        <div class="row">
            <div class="col-md-8 m-t-20 text-center">
                <button id="btupdate" runat="server" onserverclick="btnSave_Click" type="submit"
