<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Verified.aspx.vb" Inherits="GOSHRM.Verified" %>
      ...
      <div id="divalert" runat="server"  visible="false" class="alert alert-danger">
        ...
        <div class="account-page">
            <div class="container"><br />
                <h3 class="account-title">Email Verified</h3>
                <div class="account-box">
                    ...
                    <asp:Image ID="imgProfile" runat="server" Height="100px" Width="100px" onerror="this.onerror=null; this.src='/images/file2.jpg';" ImageUrl="~/images/file2.jpg" />
                        ...
                        <h3>Your email has been Comfirmed kindly click below to proceed </h3>
                        ...
                        <div class="form-group text-center">
                            <button id="btnLogin" runat="server"  onserverclick="proceedUser"   class="btn btn-primary btn-block account-btn"
                                type="submit">
                                Click here</button>
                        </div>
