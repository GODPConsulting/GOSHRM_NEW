<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="welcome.aspx.vb" Inherits="GOSHRM.welcome" %>
  ...
  <form runat="server" >
      ...
      <div class="search-container">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h1>Join the <%=company%> Team</h1><br><br /><h2>More <%--than <strong>12,000</strong>--%> jobs are waiting to Kickstart your career!</h2>
              <div class="content">
                <form method="" action="">
                  <div class="row">
                    ...
                    <div class="col-md-1 col-sm-6">
                      <button id="Button1" type="submit" onserverclick="btn_search_Click" runat="server" class="btn btn-search-icon"><i class="ti-search"></i></button>
        ...
        <div class="container">
          <div class="row">          
            ...
            <div class="col-md-12 col-sm-12">            
              <div class="about-content"><h2>You Are Welcome</h2>
                <p class="desc">You are welcome to our Recruitment Portal. Thank you for thinking about us.</p>
                <p>Our recruitment process is summarized below:</p>
                <ol style="margin-bottom:20px;">
                    <li style="list-style-type:decimal;margin-left:30px;">Register and obtain your login details (ID and password).Please remember your login details, it will be required to login and apply for a particular vacancies.</li>
                    <li style="list-style-type:decimal;margin-left:30px;">If you forget your password, use the service provided to retrieve it. A mail will be sent to your e-mail address.</li>
                    <li style="list-style-type:decimal;margin-left:30px;">Ensure your Profile has the following information before you apply for any of the jobs: 
                    <ul>
                        <li style="list-style-type:disc;margin-left:50px;">Personal Information</li>
                        <li style="list-style-type:disc;margin-left:50px;">Education Qualification and Certification</li>
                        <li style="list-style-type:disc;margin-left:50px;">Age</li>
                        <li style="list-style-type:disc;margin-left:50px;">Specialization</li>
                        <li style="list-style-type:disc;margin-left:50px;">Work Experience</li>
                        <li style="list-style-type:disc;margin-left:50px;">Referee</li>
                    </ul>
                    </li>
                    <li style="list-style-type:decimal;margin-left:30px;">To apply for any of the vacancies, follow the link provided. You will be prompted to input your ID and password to apply for your chosen vacancy...</li>
                    <li style="list-style-type:decimal;margin-left:30px;">Application process also allows you to update and amend your profile information at any time.</li>
                    <li style="list-style-type:decimal;margin-left:30px;">To update and amend your Profile, click on your profile, edit and save appropriately.</li>
                </ol>
                
                <a href="CandidateProfile" class="btn btn-common">Register Now</a>
              </div>
            </div>
          </div>
        </div>
