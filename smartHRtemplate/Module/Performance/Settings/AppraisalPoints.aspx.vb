...
Public Class AppraisalPoints
    Inherits System.Web.UI.Page
    ' Dim gridroles As Grid = New Grid()
    Dim _sortDirection As String
    Dim dtTable As DataTable
    Dim AuthenCode As String = "APPRAISALPOINT"
    Private Sub LoadGrid(LoadType As String)
        Try
            If LoadType = "All" Then
                GridVwHeaderChckbox.DataSource = Process.GetData("Performance_Points_get_all")
                'ElseIf LoadType = "Find" Then
                '    GridVwHeaderChckbox.DataSource = Process.SearchData("Performance_Points_search", txtsearch.Text.Trim)
            End If
    ...
    Protected Sub SortRecords(ByVal sender As Object, ByVal e As GridViewSortEventArgs)
        Try
            ...
            Else
                ...
                direction = " ASC"
            End If
            Dim table As DataTable = Process.GetData("Performance_Points_get_all")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            Response.Redirect("AppraisalPointUpdate", True)
        Catch ex As Exception
            Process.loadalert(divalert, msgalert, ex.Message, "danger")
        End Try
    End Sub
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Performance_Points_delete", ID)
                    End If
                Next
                LoadGrid("All")
                Process.loadalert(divalert, msgalert, "Appraisal Points deleted", "success")
            Else
