<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="KPIType.aspx.vb"
    Inherits="GOSHRM.KPIType" EnableEventValidation="false" Debug="true" %>
            ...
            <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="CSV File: KPIType, Description, WeightModel, HRSelectsReviewer {Yes/No} applicable only to 360 degree model" style="margin-right:10px;margin-left:10px;height:35px"></button>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" ItemStyle-Font-Bold="true" SortExpression="name">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Performance/Settings/KPITypeUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("name")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="EmpSetObjective" HeaderText="Employee Set Objectives"  SortExpression="EmpSetObjective"/>
                        <asp:BoundField DataField="weightmodel" HeaderText="Weight Model"  SortExpression="weightmodel"/>
                         <asp:BoundField DataField="ReviewerSelectionByHR" HeaderText="HR Selects Reviewer" SortExpression="ReviewerSelectionByHR" />
                    </Columns>
