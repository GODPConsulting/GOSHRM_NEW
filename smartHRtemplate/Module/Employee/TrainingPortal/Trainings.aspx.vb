    ...
    Private Function LoadDataTable() As DataTable
        ...
        If Session("trainingview").ToString.ToLower = "as trainee" Then
            If Session("trainingsearch") = "" Then
                strDataSet = Process.SearchDataP3("Employee_Training_Sessions2_get_all", Session("UserEmpID"), Process.DDMONYYYY(Process.FirstDay(Session("trainingyear"), 1)), Process.DDMONYYYY(Process.LastDay(Session("trainingyear"), 1)))
            Else
                strDataSet = Process.SearchDataP4("Employee_Training_Sessions2_Search", Session("UserEmpID"), Process.DDMONYYYY(Process.FirstDay(Session("trainingyear"), 1)), Process.DDMONYYYY(Process.LastDay(Session("trainingyear"), 1)), search.Value)
            End If
        Else
            If Session("trainingsearch") = "" Then
                strDataSet = Process.SearchDataP3("Employee_Training_Trainer_get_all", Session("UserEmpID"), Process.DDMONYYYY(Process.FirstDay(Session("trainingyear"), 1)), Process.DDMONYYYY(Process.LastDay(Session("trainingyear"), 1)))
            Else
                strDataSet = Process.SearchDataP4("Employee_Training_Trainer_Search", Session("UserEmpID"), Process.DDMONYYYY(Process.FirstDay(Session("trainingyear"), 1)), Process.DDMONYYYY(Process.LastDay(Session("trainingyear"), 1)), search.Value)
            End If
        End If
