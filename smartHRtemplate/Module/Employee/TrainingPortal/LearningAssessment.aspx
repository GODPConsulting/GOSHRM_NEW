<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LearningAssessment.aspx.vb" Inherits="GOSHRM.LearningAssessment"
...
<head id="Head1" runat="server">
    <title>Learning Assessment</title>
      <script src="../../Employee/TrainingPortal/Scripts/jquery-1.4.1-vsdoc.js" 
        type="text/javascript"></script>
    <script src="../../Employee/TrainingPortal/Scripts/jquery-1.4.1.js" 
        type="text/javascript"></script>
            ...
            <table width="100%">
                <tr>
                    <td style="width: 30%">
                        ...
                        <asp:Label ID="lblimage" runat="server" Visible="False" Width="3px"></asp:Label>
                        <asp:Label ID="lblPoint" runat="server" Visible="False"></asp:Label>
                    </td>
                    <td style="width: 40%">
                        <table width="100%">
                            <tr>
                                <td class="style1" colspan="2" style="background-color: #1BA691">
                                    <asp:Label ID="lblHeader" runat="server" Font-Names="Verdana" Font-Size="15px"
                                        Width="100%" style="text-align: center"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="style1" colspan="2" style="background-color: #1BA691">
                                    <asp:Label ID="lbllsession" runat="server" Font-Names="Verdana" Font-Size="13px"
                                        Width="100%" style="text-align: center"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="style1" colspan="2">
                                    <asp:Image ID="Image1" runat="server" Height="39px" ImageUrl="~/images/clock1.png"
                                        Width="39px" />
                                    <asp:Label ID="lblTimeStart" runat="server" Font-Names="Verdana" Font-Size="13px"
                                        Width="60%" Style="color: #00CC00"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="style6">
                                ...
                                <td class="style8">
                                    <asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="12px" 
                                        Style="color: #3399FF; font-weight: 700;">Duration in Minutes:</asp:Label>
                                    <asp:TextBox ID="txtDuration" runat="server" Width="28%" BorderColor="White" BorderWidth="1px"
                                        ReadOnly="True" style="font-weight: 700; color: #3399FF" Font-Bold="True" 
                            ...
                            <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txtTime" runat="server" BorderColor="White" ReadOnly="True" BorderStyle="None"
                                        Width="100%" Height="16px" Font-Names="Verdana" Font-Size="12px" 
                            ...
                            <tr valign="top">
                                ...
                                <td style="border-bottom-style: solid; border-bottom-width: thin; border-bottom-color: #C0C0C0"
                                    ...
                                    <asp:TextBox ID="txtAnswers" runat="server" BorderColor="#CCCCCC" BorderWidth="1px"
                                        ...
                                        Font-Names="Verdana" Font-Size="12px" Height="80px" ForeColor="#666666"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="style6">
                            ...
                            <tr>
                                ...
                                <td class="style8">
                                    ...
                                    <asp:Label ID="lblstart" runat="server" Font-Names="Arial" Font-Size="Small" 
                                        Style="color: #00CC00" Visible="False" Width="0px"></asp:Label>
                                </td>
                            </tr>
                    ...
                    <td style="width: 30%">
                        <asp:Label ID="lblimagetype" runat="server" Font-Names="Arial" 
                            Font-Size="Small" Style="color: #3399FF; font-weight: 700;" Visible="False"></asp:Label>
                        <asp:Label ID="lbltestquestid" runat="server" Font-Names="Arial" 
                            Font-Size="Small" Style="color: #3399FF; font-weight: 700;" Visible="False"></asp:Label>
                    </td>
                </tr>
            </table>
            ...
            <tr>
                ...
                <td style="width: 60%">
                    ...
                    <asp:Label ID="lblFinalStatus" runat="server" Font-Names="Arial" 
                        style="text-align: center; color: #33CC33; font-weight: 700;" Text="Learning Assessment successfully submitted" 
                        Width="100%"></asp:Label>
                </td>
                <td style="width: 20%">
                </td>
            ...
            <tr>
                ...
                <td style="width: 60%; text-align: center;">
                    ...
                    <asp:Button ID="btnNext0" runat="server" BackColor="#1BA691" BorderStyle="None" 
                        ForeColor="White" Height="25px" Text="Ok" Width="120px" />
                </td>
                <td style="width: 20%">
                </td>
            </tr>
