<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="MgrTrainings.aspx.vb"
    Inherits="GOSHRM.MgrTrainings" EnableEventValidation="false" Debug="true" %>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Training Session" ItemStyle-Font-Bold="true" SortExpression="Session Name">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Materials" ItemStyle-Font-Bold="true" SortExpression="Materials">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Employee/TrainingPortal/TrainingMaterial.aspx?sessionid={0}",
