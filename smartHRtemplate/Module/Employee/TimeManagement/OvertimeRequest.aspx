<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OvertimeRequest.aspx.vb"
    Inherits="GOSHRM.OvertimeRequest" EnableEventValidation="false" %>
    ...
    <table>
        ...
        <tr>
            <td class="style6" valign="top">
                <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Text="Comment" 
            ...
            <td class="style7">
                <asp:TextBox ID="txtComment" runat="server" BorderColor="#CCCCCC" 
                    ...
                    Height="115px" Font-Names="Verdana" Font-Size="12px" ForeColor="#666666"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style6">
                <asp:Label ID="Label7" runat="server" Font-Names="Verdana" Text="Manager to Approve:" 
                    Font-Size="12px" Font-Bold="True" ForeColor="#666666"></asp:Label>
            </td>
            <td class="style7">
                <asp:Label ID="lblManager" runat="server" Font-Names="Verdana" 
                    Font-Size="12px" ForeColor="#666666"></asp:Label>
            </td>
        </tr>
         <tr>
            <td class="style6" valign="top">
                <asp:Label ID="lblAgreedOvertime" runat="server" Font-Names="Verdana" 
                    Font-Size="12px" Visible="False" Font-Bold="True" ForeColor="#666666"></asp:Label>
                </td>
            <td class="style7">
                &nbsp;</td>
        </tr>
        ...
        <tr>
            <td class="style6">
                <asp:Button ID="btnAdd" runat="server" Text="Send Request" BackColor="#1BA691"
