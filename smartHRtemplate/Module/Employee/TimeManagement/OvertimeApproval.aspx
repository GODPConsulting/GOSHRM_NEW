<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OvertimeApproval.aspx.vb"
    Inherits="GOSHRM.OvertimeApproval" EnableEventValidation="false" %>
...
<body  style="height: 317px">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="style7">
                <asp:Label ID="lblShift" runat="server" Font-Names="Verdana" ForeColor="#666666"
        ...
        <tr>
            <td class="style6">
                <asp:Label ID="Label9" runat="server" Font-Names="Verdana" Text="Close Date:" Font-Bold="True" ForeColor="#666666"
                    Font-Size="12px"></asp:Label>
            </td>
            <td class="style7">
        ...
        <tr>
            ...
            <td class="style7">
                <asp:TextBox ID="txtagreedOvertime" runat="server" BorderColor="#CCCCCC" ForeColor="#666666"
                    BorderStyle="Solid" BorderWidth="1px" Width="50px" 
                    ToolTip="Set Overtime to approve" Font-Names="Verdana" Font-Size="12px"></asp:TextBox>
            </td>
        </tr>
         <tr>
            <td class="style6">
            ...
            <td class="style7">
                <asp:TextBox ID="txtovertimeindex" runat="server" BorderColor="#CCCCCC" ForeColor="#666666"
                    BorderStyle="Solid" BorderWidth="1px" Width="50px" 
                    ToolTip="Set Overtime to approve" Font-Names="Verdana" Font-Size="12px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="style7">
                <asp:TextBox ID="txtComment" runat="server" BorderColor="#CCCCCC" ForeColor="#666666"
                    ...
                    Height="76px" Font-Names="Verdana" Font-Size="12px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style6" valign="top">
         ...
         <tr>
            <td class="style6" valign="top">
                <asp:Label ID="lblhrstatuslabel" runat="server" Font-Names="Verdana" Text="HR Approval Status:" Font-Bold="True" ForeColor="#666666"
                    Font-Size="12px"></asp:Label>
             </td>
            <td class="style7">
                <asp:Label ID="lblhrstatus" runat="server" Font-Names="Verdana" ForeColor="#666666"
                    Font-Size="12px"></asp:Label>
             </td>
        </tr>
        <tr>
