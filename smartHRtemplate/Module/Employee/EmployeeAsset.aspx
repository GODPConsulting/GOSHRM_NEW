<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/smartHR.Master" CodeBehind="EmployeeAsset.aspx.vb" Inherits="GOSHRM.EmployeeAsset" EnableEventValidation="true" %>
                            ...
                            <div class="row">
                                <div class=" col-md-12">
                                    <div class="form-group">
                                        <label>
                                            Name of Asset *</label>
                                        <input id="assetsname"  runat="server"  type="text" class="form-control"
                                            />
                            ...
                            <div class="row">
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        <label>
                                            Asset Number*</label>
                                        <input id="assetsnumber" runat="server" type="text" class="form-control"
                                            />
                                ...
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        <label>
                                            Classificaion</label>
                                        <input id="classifications" runat="server" type="text" class="form-control"
                                       />
                                    </div>
                                </div>
                                </div>
                                ...
                                <div class=" col-md-12">
                                    <div class="form-group">
                                        <label>
                                            ...
                                            <input id="assetsdescription" runat="server" type="text" class="form-control"
                                            />
                            ...
                            <div class="row">
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="physicalconditions" runat="server" type="text" class="form-control"
                                            />
                                ...
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        <label>
                                            LOCATION *</label>
                                      <input id="locations" runat="server" type="text" class="form-control" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                         <label>
                                            Comments *</label>
                                        <input type="text" runat="server" id="comments" class="form-control" />
                                    </div>
                                </div>
                            </div>
