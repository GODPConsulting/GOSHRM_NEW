<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="PromotionsInitiated.aspx.vb"
    Inherits="GOSHRM.PromotionsInitiated" EnableEventValidation="false" Debug="true" %>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Employee" ItemStyle-Font-Bold="true" SortExpression="name">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Employee/Recruitment/promotionupdate?id={0}&type=mgr",
