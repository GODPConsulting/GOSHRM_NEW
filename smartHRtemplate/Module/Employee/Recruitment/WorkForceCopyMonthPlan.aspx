<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WorkForceCopyMonthPlan.aspx.vb"
    Inherits="GOSHRM.WorkForceCopyMonthPlan" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
      ...
      <script type="text/javascript">
          function Confirm() {
              ...
              if (confirm("Move Budget to selected destination month?")) {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    ResolvedRenderMode="Classic" Width="100%" ID="cboDestination" CheckBoxes="True" Skin="Bootstrap">
</telerik:RadComboBox>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-8 m-t-20 text-center">
                <asp:Button ID="btnupdate" runat="server" Text="Copy" OnClientClick="Confirm()" ForeColor="White"
                    Width="80px" Height="34px" CssClass="btn btn-success" BorderStyle="None" Font-Names="Verdana"
                    Font-Size="14px" />
