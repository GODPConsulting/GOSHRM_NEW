<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="StaffRequisition.aspx.vb"
    Inherits="GOSHRM.StaffRequisition" EnableEventValidation="false" Debug="true" %>
        ...
        <div class="row">
         <div class="search-box-wrapper col-sm-6 col-md-4 col-xs-12 form-group pull-right">
                        <asp:LinkButton ID="btDelete" data-toggle="tooltip" data-original-title="Delete" Height="35px" runat="server" CssClass="btn btn-default btn-sm" OnClick="Delete" OnClientClick="Confirm()">
                         ...
                         <button id="btAdd" type="button" data-toggle="tooltip" data-original-title="Add Staff Requisition" runat="server" class="glyphicon glyphicon-plus btn btn-default btn-sm" onserverclick="btnAdd_Click"
