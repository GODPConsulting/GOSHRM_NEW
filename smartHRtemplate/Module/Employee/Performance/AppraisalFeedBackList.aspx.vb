...
Public Class AppraisalFeedBackList
    ...
    Private Function LoadDataTable() As DataTable
        ...
        ElseIf Session("appfeedbacklistLoadType") = "Find" Then
            ...
            datatables = Process.SearchDataP2("Performance_Appraisal_Summary_Employee_Search", Session("UserEmpID"), search.Value.Trim)
        End If
        ...
        If (customName = "") Then
            divdetailheader.InnerText = " Appraisal Feedback (" & datatables.Rows.Count.ToString & ")"
        Else
