...
Public Class AppraisalFeedBackNuggetsReviewList
    ...
    Private Function LoadDataTable() As DataTable
        ...
        If Session("appfeedbacklistLoadType") = "All" Then
            datatables = Process.SearchDataP2("Performance_Appraisal_NuggetList_Review_Get_All", Request.QueryString("id"), Session("Organisation"))
        ElseIf Session("appfeedbacklistLoadType") = "Find" Then
            search.Value = Session("appfeedbacklistSearch")
            datatables = Process.SearchDataP3("Performance_Appraisal_NuggetList_Review_Search", Request.QueryString("id"), search.Value.Trim, Session("Organisation"))
        End If
        ...
        If (customName = "") Then
            divdetailheader.InnerText = " Appraisal Feedback Nuggets Review Page(" & datatables.Rows.Count.ToString & ")"
        Else
            divdetailheader.InnerText = customName + " Review Page(" & datatables.Rows.Count.ToString & ")"
        End If
        Return datatables
    End Function
    ...
    Protected Sub btnBack_Click(sender As Object, e As EventArgs)
        Try
            If Session("FromOwner") = "True" Then
                Response.Redirect("AppraisalFeedBackNuggetsOwnerList")
            Else
