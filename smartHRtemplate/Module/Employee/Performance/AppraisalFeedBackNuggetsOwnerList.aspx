<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="AppraisalFeedBackNuggetsOwnerList.aspx.vb"
    Inherits="GOSHRM.AppraisalFeedBackNuggetsOwnerList" EnableEventValidation="false" Debug="true" %>
...
<%--             <asp:LinkButton ID="btnDelete" data-toggle="tooltip" OnClientClick="Confirm()" data-original-title="Delete" Height="35px" runat="server" CssClass="btn btn-default btn-sm">
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Always">
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    BorderStyle="Solid" Font-Names="Verdana" AllowPaging="True" PageSize="100" DataKeyNames="rev_empid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="rev_name" HeaderText="Reviewer Name" SortExpression="Reviews"  />
                     ...
                     HttpUtility.UrlEncode(Eval("rev_empid").ToString())) %>' Text='<%# Eval("Reviews")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                         
                        <asp:BoundField DataField="rev_grade" HeaderText="Reviewer Jobgrade" SortExpression="emp_jgrade"/>
                        <asp:BoundField DataField="rev_title" HeaderText="Reviewer Jobtitle" SortExpression="emp_title"/>
                        <asp:BoundField DataField="emp_period" HeaderText="Review Period" SortExpression="emp_period"/> 
