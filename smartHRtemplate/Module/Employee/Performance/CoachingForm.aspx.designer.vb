...
Partial Public Class CoachingForm
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents radEndDate1 As Global.Telerik.Web.UI.RadDatePicker
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents radObjectives As Global.Telerik.Web.UI.RadComboBox
