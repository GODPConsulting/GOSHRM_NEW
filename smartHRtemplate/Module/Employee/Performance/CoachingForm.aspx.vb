...
Public Class CoachingForm
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If Not Me.IsPostBack Then
                ...
                'grateful.Items.Add(newListItem)
                ...
                If (customName = "") Then
                    pagetitle.InnerText = "Coaching Form"
                Else
                ...
                If Request.QueryString("id") IsNot Nothing Then
                    ...
                    Dim struser1 As New DataSet
                    struser1 = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Coaching_session _get", Request.QueryString("id").ToString)
                    Dim APPRAISALID = struser1.Tables(0).Rows(0).Item("KPIID").ToString
                    Label2.Text = struser1.Tables(0).Rows(0).Item("GUID").ToString
                    Dim strUser As New DataSet
                    strUser = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Performance_Appraisal_Summary_Get", APPRAISALID)
    ...
    Private Function LoadDatatable() As DataTable
        ...
        dt = Process.SearchData("Performance_Appraisal_Get_Coaching", Label2.Text)
    ...
    Public Sub submitschedule(sender As Object, e As EventArgs)
        Try
            ...
            Dim lblstatus As String = ""
            If radEndDate1.SelectedDate Is Nothing Then
            ...
            If Text2.Value = "" Then
                ...
                Process.loadalert(divalert, msgalert, lblstatus, "danger")
            End If
            If radObjectives.SelectedValue = "" Then
            ...
            SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Performance_Coaching_Add", lblid.Text, aname.Value, areviewer1.Value, str, comment1.Value, radEndDate1.SelectedDate, Text2.Value)


            For d As Integer = 0 To radObjectives.CheckedItems.Count - 1
                SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Performance_Coaching_Add_Objectives", str, radObjectives.CheckedItems.Item(d).Text)
            Next
    ...
    End Sub
    Protected Sub btnClose_Click1(sender As Object, e As EventArgs)
        Try

            Response.Redirect("~/Module/Employee/Performance/CoachingList.aspx", True)
