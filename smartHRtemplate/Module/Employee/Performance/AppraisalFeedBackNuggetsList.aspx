<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="AppraisalFeedBackNuggetsList.aspx.vb"
    Inherits="GOSHRM.AppraisalFeedBackNuggetsList" EnableEventValidation="false" Debug="true" %>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Reviewee Name"  ItemStyle-Font-Bold="true"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Employee/Performance/AppraisalFeedbackNuggets?id={0}",
                     HttpUtility.UrlEncode(Eval("AppraisalItem").ToString())) %>' Text='<%# Eval("emp_name")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>

                         <asp:BoundField DataField="period" HeaderText="Review Period" SortExpression="ReviewPeriod"  />
                        <asp:BoundField DataField="rev_submitted" HeaderText="Submitted" SortExpression="submitted"/>
                        <asp:BoundField DataField="AppraisalStatus" HeaderText="Review Cycle Status" SortExpression="AppraisalStatus"/> 
