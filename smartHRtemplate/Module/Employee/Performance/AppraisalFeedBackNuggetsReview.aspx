<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="AppraisalFeedBackNuggetsReview.aspx.vb"
    Inherits="GOSHRM.AppraisalFeedBackNuggetsReview" EnableEventValidation="false" Debug="true" %>
    ...
    <body >
        ...
        <div class="row">
            <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">
                         <button onserverclick="btnBack_Click" type="button" data-toggle="tooltip" data-original-title="Back" runat="server" class="fa fa-backward btn btn-default btn-sm"
