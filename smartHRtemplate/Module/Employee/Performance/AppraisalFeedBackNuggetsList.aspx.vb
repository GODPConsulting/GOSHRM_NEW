...
Public Class AppraisalFeedBackNuggetsList
    Inherits System.Web.UI.Page
    ' Dim gridroles As Grid = New Grid()
    Dim _sortDirection As String
    Dim dtTable As DataTable
    Dim AuthenCode As String = "APPRAISALNUGGETLIST"
    Private Function LoadDataTable() As DataTable
        Dim datatables As New DataTable
        If Session("appfeedbacklistLoadType") = "All" Then
            datatables = Process.SearchDataP3("Performance_Appraisal_NuggetList_Get_All", Session("UserEmpID"), Session("Organisation"), Session("period"))
        ElseIf Session("appfeedbacklistLoadType") = "Find" Then
            search.Value = Session("appfeedbacklistSearch")
            datatables = Process.SearchDataP3("Performance_Appraisal_NuggetList_Search", Session("UserEmpID"), search.Value.Trim, Session("Organisation"))
        End If
        ...
        If (customName = "") Then
            divdetailheader.InnerText = " Appraisal Feedback Nuggets (" & datatables.Rows.Count.ToString & ")"
        Else
            divdetailheader.InnerText = customName + " (" & datatables.Rows.Count.ToString & ")"
        End If
        Return datatables
    End Function
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            '    Exit Sub
            'End If
            Response.Redirect("~/Module/Employee/Performance/AppraisalFeedbackNuggets", True)
