...
Public Class CoachingList
    ...
    Private Function LoadGrid() As DataTable
        ...
        If radYear.Text = "Due" Then

            datatables = Process.SearchData("Coaching_session _list_get_all", Session("UserEmpID"))
        Else
            datatables = Process.SearchData("Coaching_session _list_get_all_past", Session("UserEmpID"))
        End If
        ...
        If (customName = "") Then
            divdetailheader.InnerText = "Coaching List (" & datatables.Rows.Count.ToString & ")"
        Else
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                radYear.Items.Clear()
                radYear.Items.Add("Due")
                radYear.Items.Add("Past Due")
