<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/smartHR.Master" CodeBehind="CoachingList.aspx.vb" Inherits="GOSHRM.CoachingList" EnableEventValidation="false" Debug="true" %>
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    ...
                    <%--<div class="text-center">
                        <button class="btn-default glyphicon glyphicon-backward btn btn-sm" type="button" data-toggle="tooltip" data-original-title="Back" runat="server" onserverclick="btnBack_Click" ></button>
                    </div>--%>
                </div>
...
<ItemStyle Width="5%"></ItemStyle>
                        ...
                        <asp:TemplateField HeaderText="Date"  ItemStyle-Font-Bold="true" 
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#String.Format("~/Module/Employee/Performance/CoachingForm?id={0}",
                                 HttpUtility.UrlEncode(Eval("id").ToString())) %>' DataFormatString="{0:dd, MMM yyyy}" Text='<%# Eval("Date")%>' />
                            </ItemTemplate>

<ItemStyle Font-Bold="True"></ItemStyle>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Time"  HeaderText="Time" SortExpression="Time" />
                        <asp:BoundField DataField="Period"  HeaderText="Review Period" SortExpression="coachname" />
