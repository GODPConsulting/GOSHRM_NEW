...
Imports System.IO
Public Class WorkShiftsExemption
    Inherits System.Web.UI.Page
    ' Dim gridroles As Grid = New Grid()
    Dim _sortDirection As String
    Dim dtTable As DataTable
    Dim AuthenCode As String = "WORKSHIFTEXE"
    Dim Pages As String = "Work Shift Exemptions"
    ...
    Private Function LodaDataTable(LoadType As String) As DataTable
        ...
        If LoadType = "All" Then
            Datas = Process.GetData("Job_Work_Shift_Exemptions_get_all")
        ElseIf LoadType = "Find" Then
            Datas = Process.SearchData("Job_Work_Shift_Exemptions_search", txtsearch.Value.Trim)
        End If
    ...
    Protected Sub SortRecords(ByVal sender As Object, ByVal e As GridViewSortEventArgs)
        Try
            ...
            Else
                ...
                direction = " ASC"
            End If
            Dim table As DataTable = LodaDataTable(Session("LoadType")) 'Process.GetData("Job_Work_Shift_Exemptions_get_all")
    ...
    Protected Sub GridVwHeaderChckbox_PageIndexChanging(sender As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GridVwHeaderChckbox.PageIndexChanging
        Try
            ...
            GridVwHeaderChckbox.DataSource = LodaDataTable(Session("LoadType")) 'Process.GetData("Job_Work_Shift_Exemptions_get_all")
            GridVwHeaderChckbox.DataBind()
        Catch ex As Exception
        End Try
    End Sub
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            Response.Redirect("~/Module/TimeManagement/WorkShiftExemptionUpdate.aspx", True)
        Catch ex As Exception
            Process.loadalert(divalert, msgalert, ex.Message, "danger")
        End Try
    End Sub
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Job_Work_Shift_Exemptions_delete", ID)
                    End If
                Next
                LoadGrid(Session("LoadType"))
            Else
