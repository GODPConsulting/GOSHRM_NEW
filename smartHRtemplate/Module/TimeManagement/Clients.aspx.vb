...
Public Class Clients
    ...
    Private Function LoadData() As DataTable
        ...
        If Session("LoadType") = "All" Then
            datas = Process.GetData("Time_Clients_get_all")
        ElseIf Session("LoadType") = "Find" Then
            datas = Process.SearchData("Time_Clients_search", search.Value.Trim)
        End If
        pagetitle.InnerHtml = search.Value & " CLIENTS (" & datas.Rows.Count.ToString & ")"
        Return datas
    End Function
    ...
    Protected Sub SortRecords(ByVal sender As Object, ByVal e As GridViewSortEventArgs)
        Try
            ...
            Else
                ...
                direction = " ASC"
            End If
            Dim table As DataTable = Process.GetData("Time_Clients_get_all")
    ...
    Protected Sub GridVwHeaderChckbox_PageIndexChanging(sender As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GridVwHeaderChckbox.PageIndexChanging
        Try
            ...
            GridVwHeaderChckbox.DataSource = Process.GetData("Time_Clients_get_all")
            GridVwHeaderChckbox.DataBind()
        Catch ex As Exception
        End Try
    End Sub
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            Response.Redirect("~/Module/TimeManagement/ClientsUpdate.aspx", True)
        Catch ex As Exception
            Process.loadalert(divalert, msgalert, ex.Message, "danger")
        End Try
    End Sub
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Time_Clients_delete", ID)
                    End If
                Next
                LoadGrid("All")
            Else
