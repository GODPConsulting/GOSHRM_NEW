...
Public Class TimeSheetAdmin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                ...
                rdoStatus.Items.Add("Pending Approval")
                rdoStatus.Items.Add("Approved")
                rdoStatus.Items.Add("Reject")


                rdoHRStatus.Items.Clear()
                rdoHRStatus.Items.Add("Pending Approval")
                rdoHRStatus.Items.Add("Approved")
                rdoHRStatus.Items.Add("Reject")


                Process.LoadRadDropDownTextAndValueP1(radProject, "Time_Projects_Get_My", Session("UserEmpID"), "name", "id")
                ...
                If Request.QueryString("id") IsNot Nothing Then
                    ...
                    If Session("UserEmpID") = strUser.Tables(0).Rows(0).Item("Approver").ToString Then
                        ...
                        lblActStatus.Visible = True
                        rdoStatus.Visible = True
                        btnAdd.Visible = False
        ...
        End Try
    End Sub
    Private Function GetIdentity(ByVal sEmpID As String, ByVal ProjectID As String, ByVal Activity As String, ByVal ActivityDate As Date, ByVal starttime As String, ByVal enddate As String, ByVal duration As Integer, ByVal note As String, ByVal PM As String, ByVal user As String) As String
        Try
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            ...
            If txtid.Text <> "0" And txtid.Text.Trim <> "" Then
                SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Time_Sheet_Update", TimeSheet.id, TimeSheet.Employee, radProject.SelectedItem.Value, TimeSheet.Activity, TimeSheet.ActivityDate, TimeSheet.StartTime, TimeSheet.EndTime, TimeSheet.Duration, TimeSheet.Note, pmID, Session("LoginID"))
            Else
                txtid.Text = GetIdentity(TimeSheet.Employee, radProject.SelectedItem.Value, TimeSheet.Activity, TimeSheet.ActivityDate, TimeSheet.StartTime, TimeSheet.EndTime, TimeSheet.Duration, TimeSheet.Note, pmID, Session("LoginID"))
    ...
    Protected Sub btnStatus_Click(sender As Object, e As EventArgs) Handles btnStatus.Click
        Try
            ...
            SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Time_Sheet_Update_Status", TimeSheet.id, TimeSheet.StartTime, TimeSheet.EndTime, TimeSheet.Duration, TimeSheet.Note, TimeSheet.Status, txtComment.Text)
            ...
            strHR = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Emp_PersonalDetail_Get_HR_Staff")
    ...
    Protected Sub radProject_SelectedIndexChanged(sender As Object, e As Telerik.Web.UI.DropDownListEventArgs) Handles radProject.SelectedIndexChanged
        Try
            ...
            strEmp = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, CommandType.Text, "select employee from dbo.Employees_All where empid = '" & Session("UserEmpID") & "'")
    ...
    Protected Sub btnHR_Click(sender As Object, e As EventArgs) Handles btnHR.Click
        Try
            ...
            SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Time_Sheet_HR_Update", txtid.Text, Session("UserEmpID"), rdoHRStatus.SelectedItem.Text)
        Catch ex As Exception
            lblstatus.Text = ex.Message
        End Try
    End Sub
