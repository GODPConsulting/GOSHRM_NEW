<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="WorkShifts.aspx.vb"
    Inherits="GOSHRM.WorkShifts" EnableEventValidation="false" Debug="true" %>
        ...
        <div>
            <div>
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    OnRowDataBound="OnRowDataBound" Width="100%" Height="70px" ToolTip="click row to view detail" CssClass="table table-condensed"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Shift Name" ItemStyle-Width="50px" 
                             ItemStyle-Font-Bold="true">
                            <ItemTemplate>
                                <a href="WorkShiftUpdate.aspx?id=<%# Eval("id") %> ">
                                    <%# Eval("shiftname")%></a>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="timeFrom" ItemStyle-Width="20px" HeaderText="From" />
                        <asp:BoundField DataField="timeTo" ItemStyle-Width="20px" HeaderText="To" />
                        <asp:BoundField DataField="duration" ItemStyle-Width="10px" HeaderText="Hours Per Day" />
                ...
                <script type="text/javascript">
                    function openWindow(code) {
                        window.open("WorkShiftUpdate.aspx?id=" + code, "open_window", "width=500,height=400");
                    }
                </script>
