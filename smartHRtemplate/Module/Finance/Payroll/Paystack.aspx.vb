...
Public Class Paystack
    ...
    Dim AuthenCode As String = "PAYSTACK"
    Dim Approvalstatic As String = ""
    Public paystatus As String = "False"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                ...
                Dim paymentstatus As New DataSet
                paymentstatus = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Finance_Payslip_Get_payment_status", txtid.Text)
                If paymentstatus.Tables(0).Rows.Count > 0 Then
                    Session("paystatus") = paymentstatus.Tables(0).Rows(0).Item("paymentstatus").ToString                   
                End If
                paystatus = Session("paystatus")

                PKeys.Text = SqlHelper.ExecuteScalar(WebConfig.ConnectionString, CommandType.Text, "select Paystack_keys from Paystack")
                PKeys.Text = "Bearer " + PKeys.Text
    ...
    Protected Sub Delete(sender As Object, e As EventArgs) Handles btDelete.Click
        Try
            ...
            If confirmValue = "Yes" Then
                If lbapproval.InnerText.ToLower.Contains("approved") = True Then
                ...
                Else
                    ...
                    For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                        ...
                        If cb IsNot Nothing AndAlso cb.Checked Then
                            ...
                            SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Finance_Payslip_Delete_paystack", ID, pid)
                        End If
                    Next
    ...
    Public Sub btnRefresh_Click(sender As Object, e As EventArgs)
        Try
            LoadLoans()
            paystatus = Session("paystatus")
            'Process.loadalert(divalert, msgalert, "Successfully Refreshed", "success")
        Catch ex As Exception
