...
Public Class PayrollOption
    ...
    Dim Pages As String = "Loan Types"
    Private Function LoadData() As DataTable
        Dim dt As New DataTable
        If Session("LoadType") = "All" Then
            dt = Process.SearchData("Payroll_Options_get_all", Session("Access"))
        ElseIf Session("LoadType") = "Find" Then
            dt = Process.SearchDataP2("Payroll_Options_search", Session("Access"), txtsearch.Value.Trim)
        End If
        pagetitle.InnerText = txtsearch.Value & " Payroll Options (" & dt.Rows.Count.ToString & ")"
        Return dt
    End Function
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            If Process.AuthenAction(Session("role"), AuthenCode, "Create") = False Then
                ...
                Exit Sub
            End If
            Response.Redirect("PayrollOptionUpdate.aspx", True)
        Catch ex As Exception
            Process.loadalert(divalert, msgalert, ex.Message, "danger")
        End Try
    End Sub
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Payroll_Options_delete", ID)
                    End If
                Next
                LoadGrid("All")
            Else
