<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="FinancialCalendar.aspx.vb"
    Inherits="GOSHRM.FinancialCalendar" EnableEventValidation="false" Debug="true" %>
            ...
            <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="CSV File (Comma Delimited): Year, Start date, End date" style="margin-right:10px;margin-left:10px;height:35px"></button>
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Year" ItemStyle-Font-Bold="true" SortExpression="name">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Finance/Settings/FinCalendarUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("name")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Period Start" HeaderText="Period Start" SortExpression="Period Start"
                            DataFormatString="{0:dd, MMM yyyy}" />
                        <asp:BoundField DataField="Period End" HeaderText="Period End" SortExpression="Period End"
                            DataFormatString="{0:dd, MMM yyyy}" />
                    </Columns>
