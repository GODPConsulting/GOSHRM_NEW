<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup ="true" CodeBehind="EmployerPenConUpdate.aspx.vb" Inherits="GOSHRM.EmployerPenConUpdate" EnableEventValidation="false" Debug="true"%>
                ...
                <asp:TextBox ID="txtid" runat="server" Width="3px"  
                   ...
                   <div class="panel panel-success">
                        <div class="panel-heading">
                            <h5><b id="pagetitle" runat="server">PENSION CONTRIBUTION</b></h5>
                        </div>
                    ...
                    BackColor="White" Font-Names="Verdana" Skin="Bootstrap"
                                Font-Size="12px" Width="100%" ID="cboJobGrade" Height="73px" 
                                AutoPostBack="True">
                        ...
                        <div class=" col-md-12">
                            <div class="form-group">
                                ...
                                <input id="txtecontribution" runat="server" class="form-control" type="text" />
                            </div>
                        </div>
                        <div class=" col-md-12">
                            <div class="form-group">
...
<%--    <table>
        ...
        <tr>
            ...
            <td class="style7">
                    ...
                    ID="txtecontribution"></asp:TextBox>
