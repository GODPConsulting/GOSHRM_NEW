<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="WorkForceAnalysis.aspx.vb"
    Inherits="GOSHRM.WorkForceAnalysis" EnableEventValidation="false" Debug="true" %>
      ...
      <div class="container col-md-12">        
        ...
        <div class="panel panel-success">
                <div class="panel-heading">
                    <h5 class="page-title"><b  id="pagetitle" runat="server">WORKFORCE ANALYSIS REPORT</b></h5>
                </div>
             <div class="panel-body">
              <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <telerik:RadComboBox Skin="Bootstrap" runat="server"
                                     Width="100%" ID="radYear" AutoPostBack="True" 
                                     Font-Names="Verdana" Font-Size="11px">
                                </telerik:RadComboBox>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                     <telerik:RadComboBox Skin="Bootstrap" runat="server"
                                       Width="100%" ID="radMonth" 
                                         Font-Names="Verdana" Font-Size="11px">
                                    </telerik:RadComboBox>      
                                </div>
                                </div>                                        
                       ...
                       <div class="col-md-12 m-t-5 text-left">
                            ...
                            <asp:CheckBox ID="chkChart" runat="server" Font-Names="Verdana" 
                            Font-Size="11px" Text="Show Chart" />
                        </div>
             </div>
