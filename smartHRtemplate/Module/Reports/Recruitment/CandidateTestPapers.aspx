<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="CandidateTestPapers.aspx.vb"
    Inherits="GOSHRM.CandidateTestPapers" EnableEventValidation="false" Debug="true" %>
    ...
    <body>
       ...
       <div class="panel panel-success">
                        <div class="panel-heading">
                            <h5><b id="pagetitle" runat="server">ONLINE TEST REPORT</b></h5>
                        </div>
                        ...
                        <div class=" col-md-4">
                         ...
                         <div class=" col-md-4">
                            <div class="form-group">
                                ...
                                <telerik:RadComboBox ID="radTest" Skin="Bootstrap" runat="server" Width="100%"   Font-Size="12px" ForeColor="#666666"
                                     AutoPostBack="True">
                                </telerik:RadComboBox>
                            </div>
                        </div>
