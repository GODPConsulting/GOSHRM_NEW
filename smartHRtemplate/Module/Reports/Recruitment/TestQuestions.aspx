<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="TestQuestions.aspx.vb"
    Inherits="GOSHRM.TestQuestions" EnableEventValidation="false" Debug="true" %>
    ...
    <body>
       ...
       <div class="panel panel-success">
                        <div class="panel-heading">
                            <h5><b id="pagetitle" runat="server">TEST QUESTIONS REPORT</b></h5>
                        </div>
                        ...
                        <div class=" col-md-4">
                         ...
                         <div class=" col-md-4">
                            <div class="form-group">
                                ...
                                <telerik:RadComboBox ID="cboJobTest" Skin="Bootstrap" runat="server" Width="100%"   Font-Size="12px" ForeColor="#666666"
                                     AutoPostBack="True">
                                </telerik:RadComboBox>
                            </div>
                        </div>
        ...
        <div class="row">
            <div>
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
                    ...
                    <LocalReport ReportPath="Module\Recruitment\Reports\TestQuestion.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="SqlDataSource1" Name="TestQuestion" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
            </div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="Recruit_Job_Test_Questions_Report" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="cboJobPost" Name="JobID" 
                        PropertyName="SelectedValue" Type="Int32" />
                    <asp:ControlParameter ControlID="cboJobTest" Name="TestTitle" 
