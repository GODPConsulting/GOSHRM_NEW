<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="PersonalTaxReport.aspx.vb"
    Inherits="GOSHRM.PersonalTaxReport" EnableEventValidation="false" Debug="true" %>
        ...
        <div class="content container-fluid">
           ...
           <div class="panel panel-success">
            ...
            <%--<table>
                <tr>
                    <td class="style24">
                        <asp:Label ID="Label4" runat="server" Font-Names="Verdana" Text="From" 
                    ...
                    <td>
                        ...
                        <asp:Label ID="Label1" runat="server" Font-Names="Verdana" Font-Size="11px">To</asp:Label>
                    </td>
                    <td>
                ...
                <div class="row">
                    <div class="col-sm-3 col-md-3 col-xs-6">
                        <div class="form-group form-focus">
                            ...
                            ID="cboStartYear" skin="Bootstrap" Font-Names="Verdana" ForeColor="#666666">
                            </telerik:RadComboBox>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-md-3 col-xs-6">
                        <telerik:RadComboBox runat="server" 
                                                 RenderMode="Lightweight" 
                                                ResolvedRenderMode="Classic" Width="100%" 
                            ID="cboEndYear" skin="Bootstrap" Font-Names="Verdana" ForeColor="#666666">
                        </telerik:RadComboBox>
                    </div>
