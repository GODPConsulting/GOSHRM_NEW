<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="StaffProjectEfficiency.aspx.vb"
    Inherits="GOSHRM.StaffProjectEfficiency" EnableEventValidation="false" Debug="true" %>
        ...
        <form id="form1">
              ...
              <div class="panel panel-success">
                        <div class="panel-heading">
                            <h5><b id="pagetitle" runat="server">PROJECT MEMBER EFFICIENCY REPORT</b></h5>
                        </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>CLIENT</label>
                                <telerik:RadComboBox ID="cboClient" Skin="Bootstrap" runat="server" Width="100%" 
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                <label>PROJECT</label>
                                <telerik:RadComboBox ID="cboProject" Skin="Bootstrap" runat="server" Width="100%"   Font-Size="12px" ForeColor="#666666"
                                     AutoPostBack="True">
                                </telerik:RadComboBox>
                            </div>
                        </div>
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <telerik:RadComboBox ID="cboMember" Skin="Bootstrap" runat="server" Width="100%"   Font-Size="12px" ForeColor="#666666"
                                     AutoPostBack="True">
                                </telerik:RadComboBox>
                            </div>
                        </div>
