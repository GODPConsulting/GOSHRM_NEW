...
Public Class LeaveType
    ...
    Dim Pages As String = "Leave Type"
    Private Function LoadDatatable() As DataTable
        Dim dt As New DataTable
        If Session("leavetypeLoadType") = "All" Then
            dt = Process.GetData("Leave_Type_get_all")
        ElseIf Session("leavetypeLoadType") = "Find" Then
            search.Value = Session("leavetypeSearch")
            dt = Process.SearchData("Leave_Type_search", Session("leavetypeSearch"))
        End If
        pagetitle.InnerText = "Leave Type (" & dt.Rows.Count.ToString & ")"
        Return dt
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                ...
                If Session("leavetypeLoadType") Is Nothing Then
                    Session("leavetypeLoadType") = "All"
                End If
                LoadGrid()
            End If
        Catch ex As Exception
    ...
    Protected Sub SortRecords(ByVal sender As Object, ByVal e As GridViewSortEventArgs)
        Try
            ...
            Session("leavetypesortExpression") = sortExpression
    ...
    Protected Sub btnFind_Click(sender As Object, e As EventArgs)
        Try
            ...
            If search.Value.Trim = "" Then
                Session("leavetypeLoadType") = "All"
            Else
                Session("leavetypeSearch") = search.Value.Trim
                Session("leavetypeLoadType") = "Find"
            End If
            LoadGrid()
            'End If
        Catch ex As Exception
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            Response.Redirect("~/Module/Admin/LeaveTypeUpdate", True)
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Leave_Type_delete", ID)
                    End If
                Next
    ...
    Private Sub GridVwHeaderChckbox_RowCreated(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridVwHeaderChckbox.RowCreated
        Try
            Process.SortArrow(e, SortsDirection, Session("leavetypesortExpression"))
        Catch ex As Exception
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        Try
            If Process.ExportExcel(LoadDatatable(), "LeaveType") = False Then
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs)
        Try
            ...
            If Not file1.PostedFile Is Nothing Then
                ...
                If Process.Import(csvPath, "Leave_Type_Upload", Pages) = True Then
