<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="JobTitles.aspx.vb"
    Inherits="GOSHRM.JobTitles" EnableEventValidation="false" Debug="true" %>
        ...
        <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">               
                    ...
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="CSV File: Job Title, Job Description, Skills, Skills Description" style="margin-right:10px;margin-left:10px;height:35px"></button>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" ItemStyle-VerticalAlign="Top" SortExpression="name"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/JobTitleUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("name")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="skills" HeaderText="Skills" SortExpression="skills" />
                        <asp:BoundField DataField="ratings" HeaderText="Total Weight(%)" SortExpression="ratings" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n}"/>
                    </Columns>
