<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="Deductions.aspx.vb"
    Inherits="GOSHRM.Deductions" EnableEventValidation="false" Debug="true" %>
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Payslip Item" ItemStyle-Font-Bold="true"
                            SortExpression="Title">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/FinanceAdmin/DeductionsUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("Title")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="inputtype" HeaderText="Type"
                            SortExpression="inputtype" />
                        <asp:BoundField DataField="Amount"  HeaderText="Amount" ItemStyle-HorizontalAlign="Right"
                            DataFormatString="{0:n}" SortExpression="Amount" />
                        <asp:BoundField DataField="expirationdate" HeaderText="Expiration Date"
                            DataFormatString="{0:dd, MMM yyyy}" SortExpression="deductiondate" />
                        <asp:BoundField DataField="Active" HeaderText="Active" />
                        <asp:BoundField DataField="Ordering" HeaderText="Position"
                            SortExpression="Ordering" />
                    </Columns>
