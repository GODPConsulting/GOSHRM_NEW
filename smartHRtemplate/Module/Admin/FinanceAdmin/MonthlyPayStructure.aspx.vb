...
Imports System.IO
Public Class MonthlyPayStructure
    Inherits System.Web.UI.Page
    ' Dim gridroles As Grid = New Grid()
    Dim _sortDirection As String
    Dim dtTable As DataTable
    Dim AuthenCode As String = "MONTHPAY"
    Dim Pages As String = "Payroll Earning Items"
    Private Function LoadData() As DataTable
        Dim dt As New DataTable
        If Session("LoadType") = "All" Then
            dt = Process.GetData("Finance_Monthly_Earning_Items_get_all")
        ElseIf Session("LoadType") = "Find" Then
            dt = Process.SearchData("Finance_Monthly_Earning_Items_search", search.Value.Trim)
        End If
        pagetitle.InnerText = "Monthly Earning Items(" & dt.Rows.Count.ToString & ")"
        Return dt
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                Dim tooltips As String = "CSV File: Payslip Item, IsTaxable: {Yes/No}, ItemType {Fixed Amount/Percentage}, Figure,AttendanceBased {Yes/No},Active {False/True}, Position"
                btnUploads.Attributes.Add("title", tooltips.ToLower)
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            Response.Redirect("~/Module/Admin/FinanceAdmin/MonthlyStructureUpdate.aspx", True)
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Finance_Monthly_Earning_Items_delete", ID)
                    End If
                Next
    ...
    Private Shared Function GetCellText(cell As DataControlFieldCell) As String
        Dim current As New Object
        If cell.Controls.Count = 0 Then
            Return CsvFormatted(cell.Text)
        Else
            For Each current_loopVariable As Object In cell.Controls
                ...
                ElseIf TypeOf current Is DataBoundLiteralControl Then
                    Return CsvFormatted(TryCast(current, DataBoundLiteralControl).Text)
                Else
                    current.ToString()
                End If
            Next
    ...
    Private Shared Sub PrepareControlForExport(control As Control)
        For i As Integer = 0 To control.Controls.Count - 1
            ...
            ElseIf TypeOf current Is DropDownList Then
                control.Controls.Remove(current)
                control.Controls.AddAt(i, New LiteralControl(TryCast(current, DropDownList).SelectedValue))
            ElseIf TypeOf current Is CheckBox Then
                control.Controls.Remove(current)
            ...
            If current.HasControls() Then
                MonthlyPayStructure.PrepareControlForExport(current)
            End If
        Next
    End Sub
        ...
        Using sw As New StringWriter()
            Using htw As New HtmlTextWriter(sw)
                ...
                For Each row As GridViewRow In gv.Rows
                    MonthlyPayStructure.PrepareControlForExport(row)
                    table.Rows.Add(row)
                Next
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        Try
            ...
            If Process.ExportExcel(LoadData(), "PayrollEarningItem") = False Then
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs)
        Try
            ...
            If Not file1.PostedFile Is Nothing Then
                ...
                If Process.ImportWithUsers(csvPath, "Finance_Monthly_Earning_Items_Upload", Pages) = True Then
