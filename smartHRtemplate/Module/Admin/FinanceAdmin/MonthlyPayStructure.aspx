<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="MonthlyPayStructure.aspx.vb"
    Inherits="GOSHRM.MonthlyPayStructure" EnableEventValidation="false" Debug="true" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">    
    ...
    <div class="info">
        <p>
            <strong>NOTE:</strong> Leave Allowance &amp; Pensions are set in Leave Setup and
            Pension Setups respectively only</p>
    </div>
    <div class="row">
            <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploads" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Payslip Item" ItemStyle-Font-Bold="true" SortExpression ="Payslip Item" >
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/FinanceAdmin/MonthlyStructureUpdate.aspx?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>'  Text='<%# Eval("Payslip Item")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                        <asp:BoundField DataField="IsTaxable" HeaderText="Taxable" SortExpression ="IsTaxable"/>
                        <asp:BoundField DataField="Item Type" HeaderText="Type" SortExpression ="Item Type" />
                        <asp:BoundField DataField="Amount / Percentage" HeaderText="Amount" SortExpression="Amount / Percentage"
                            ItemStyle-HorizontalAlign="Right" DataFormatString="{0:n}"/>
                        <asp:BoundField DataField="AttendanceBased" HeaderText="Attendance Based" SortExpression="AttendanceBased" />
                        <asp:BoundField DataField="Active" HeaderText="Active" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="Ordering" HeaderText="Position" ItemStyle-HorizontalAlign="Right" SortExpression="Ordering" />
