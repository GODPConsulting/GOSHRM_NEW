...
Public Class Tax
    ...
    Private Function LoadDatatable() As DataTable
        ...
        If Session("LoadType") = "All" Then
            dt = Process.SearchData("Finance_Tax_Get_All", Session("LoginID"))
        ElseIf Session("LoadType") = "Find" Then
            dt = Process.SearchDataP2("Finance_Tax_search", Session("LoginID"), search.Value.Trim)
        End If
        pagetitle.InnerText = "Tax (" & dt.Rows.Count.ToString & ")"
        Return dt
    End Function
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Finance_Tax_Delete", ID)
                    End If
                Next
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            End If
            Session("isnew") = "1"
            Response.Redirect("~/Module/Admin/FinanceAdmin/TaxSetup.aspx", True)
