<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="NonPayrollItems.aspx.vb"
    Inherits="GOSHRM.NonPayrollItems" EnableEventValidation="false" Debug="true" %>
            ...
            <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="" style="margin-right:10px;margin-left:10px;height:35px"></button>
                        <button id="btnExportData" data-toggle="tooltip" data-original-title="Export" type="button" runat="server" class="fa fa-download btn btn-default btn-sm" onserverclick="btnExport_Click"
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Item" ItemStyle-Width="100px" ItemStyle-Font-Bold="true" SortExpression="item" >
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/FinanceAdmin/NonPayrollItemUpdate.aspx?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>'  Text='<%# Eval("item")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                        <asp:BoundField DataField="itemtype" ItemStyle-Width="70px" HeaderText="Type" SortExpression="itemtype" />                     
                        <asp:BoundField DataField="Active" ItemStyle-Width="50px" HeaderText="Active" SortExpression="active" />
                        <asp:BoundField DataField="Ordering" ItemStyle-Width="10px" HeaderText="Position" ItemStyle-HorizontalAlign="Right" SortExpression="ordering" />
