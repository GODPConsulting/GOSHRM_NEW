...
Public Class Deductions
    ...
    Dim Pages As String = "Payroll Deduction Items"
    Private Function LoadData() As DataTable
        Dim dt As New DataTable
        If Session("LoadType") = "All" Then
            dt = Process.GetData("Finance_Deduction_get_all")
        ElseIf Session("LoadType") = "Find" Then
            dt = Process.SearchData("Finance_Deduction_search", search.Value.Trim)
        End If
        pagetitle.InnerText = "Deductions(" & dt.Rows.Count.ToString & ")"
        Return dt
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                ...
                Dim tooltips As String = "CSV File: Payslip Item, Note, ItemType {Fixed Amount/Percentage},Expiration Date, Figure,Active {False/True}, Position"
                btnupload.Attributes.Add("title", tooltips.ToLower)
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            End If
            Session("isnew") = "1"
            'Response.Write("<script language='javascript'> { popup = window.open(""DeductionsUpdate.aspx"" , ""Stone Details"", ""height=600,width=600,status=yes,resizable=no,toolbar=no,menubar=no,location=center,scrollbars=yes,resizable=no"");  popup.focus(); }</script>")
            Response.Redirect("~/Module/Admin/FinanceAdmin/DeductionsUpdate", True)
        Catch ex As Exception
            Process.loadalert(divalert, msgalert, ex.Message, "danger")
        End Try
    End Sub
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        Try
            If Process.ExportExcel(LoadData, "PayrollDeductions") = False Then
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs)
        Try
            ...
            If Not file1.PostedFile Is Nothing Then
                ...
                If Process.ImportUsers(csvPath, "Finance_Deduction_Upload", Pages) = True Then
