...
Public Class NonPayrollItems
    ...
    Private Function LoadData() As DataTable
        ...
        If Session("LoadType") = "All" Then
            dt = Process.GetData("Finance_Non_Payroll_Items_get_all")
        ElseIf Session("LoadType") = "Find" Then
            dt = Process.SearchData("Finance_Non_Payroll_Items_search", search.Value.Trim)
        End If
        pagetitle.InnerText = "Non Payroll Items (" & dt.Rows.Count.ToString & ")"
        Return dt
    End Function
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                Dim tooltips As String = "CSV File: ItemName, ItemType {Fixed Amount/Percentage}, Active {False/True}, Position"
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            End If
            Session("isnew") = "1"
            Response.Redirect("~/Module/Admin/FinanceAdmin/NonPayrollItemUpdate.aspx", True)
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Finance_Non_Payroll_Items_delete", ID)
                    End If
                Next
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        Try
            If Process.ExportExcel(LoadData(), "NonPayrollItem") = False Then
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs)
        Try
            ...
            If Not file1.PostedFile Is Nothing Then
                ...
                If Process.ImportWithUsers(csvPath, "Finance_Non_Payroll_Items_Upload", Pages) = True Then
