...
Public Class OLSubjectUpdate
        ...
        Try
            If Not Me.IsPostBack Then
                ...
                If Request.QueryString("id") IsNot Nothing Then
                    ...
                    strUser = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Recruit_OLevel_Subject_get", Request.QueryString("id"))
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            If txtid.Text = "0" Then
                ...
                End If
            Else
                SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Recruit_OLevel_Subject_update", txtid.Text, aname.Value.Trim)
            End If
    ...
    Private Function GetIdentity() As String
        Try
            ...
            cmd.CommandText = "Recruit_OLevel_Subject_update"
