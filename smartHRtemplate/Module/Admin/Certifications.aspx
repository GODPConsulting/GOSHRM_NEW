<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup ="true" CodeBehind="Certifications.aspx.vb" Inherits="GOSHRM.Certifications" EnableEventValidation="false" Debug="true"%>
...
<body>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" ItemStyle-Width="100px" ItemStyle-Font-Bold="true"
                            SortExpression="name">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/CertificationsUpdate.aspx?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("name")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                       <asp:BoundField DataField="Description" ItemStyle-Width="250px" HeaderText="Description" SortExpression="Description" /> 
                    </Columns>
    ...
    <%-- <div>
         ...
         <table class="style21">
             <tr>
                 <td class="style22">
                     <asp:TextBox ID="txtsearch" runat="server" Width="251px" Height = "15px" 
                 ...
                 <td>
                     <asp:Button ID="btnFind" runat="server" Text="Search" BackColor="#1BA691" 
                         ForeColor="White" Width="80px" Height = "20px" BorderStyle="None" Font-Names="Verdana" 
                                   Font-Size="11px"/>
                 </td>
                 <td>
                 </td>
        ...
        <div>
            <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Rows" ItemStyle-Width="5px" HeaderText="Rows" />
                        <asp:TemplateField HeaderText="Name" ItemStyle-Width="100px" ItemStyle-Font-Bold="true" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/CertificationsUpdate.aspx?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' onclick="window.open (this.href, 'popupwindow',  'width=500,height=400,scrollbars,resizable'); return false;"
                        ...
                        <asp:BoundField DataField="Description" ItemStyle-Width="250px" HeaderText="Description" />                 
                 </Columns>
            ...
            <script type="text/javascript">
                function openWindow(code) {
                    window.open("CertificationsUpdate.aspx?id=" + code, "open_window", "width=500,height=400");
                }
            </script>
