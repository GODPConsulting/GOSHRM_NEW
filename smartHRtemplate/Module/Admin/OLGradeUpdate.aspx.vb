...
Public Class OLGradeUpdate
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            'Process.LoadRadCombo(radEducationLevel, "Recruit_OLevel_Grade_Level_Get_all", 0)
            If Not Me.IsPostBack Then
                Session("clicked") = "4"
                If Request.QueryString("id") IsNot Nothing Then
                    Dim strUser As New DataSet
                    strUser = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Recruit_OLevel_Grade_get", Request.QueryString("id"))
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            If txtid.Text = "0" Then
                ...
                End If
            Else
                SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Recruit_OLevel_Grade_Update", txtid.Text, aname.Value.Trim, adesc.Value, arank.Value)
            End If
    ...
    Private Function GetIdentity() As String
        Try
            ...
            cmd.CommandText = "Recruit_OLevel_Grade_Update"
