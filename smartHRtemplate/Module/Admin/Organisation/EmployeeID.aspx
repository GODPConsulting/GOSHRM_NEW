<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="EmployeeID.aspx.vb"
    Inherits="GOSHRM.EmployeeID" EnableEventValidation="false" Debug="true" %>
        ...
        <div class="panel panel-success">
          ...
          <div class="search-box-wrapper col-sm-6 col-md-4 col-xs-12 form-group pull-right">
                        <asp:LinkButton ID="btnDelete" data-toggle="tooltip" data-original-title="Delete" Height="35px" runat="server" CssClass="btn btn-default btn-sm" OnClick="btnDelete_Click" OnClientClick="Confirm()">
                         ...
                         <button id="btAdd" type="button" data-toggle="tooltip" data-original-title="Add Identity Format" runat="server" class="glyphicon glyphicon-plus btn btn-default btn-sm" onserverclick="btnAdd_Click"
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Company" ItemStyle-Width="200px" ItemStyle-VerticalAlign="Top"
                            ItemStyle-HorizontalAlign="Left" ItemStyle-Font-Bold="true" SortExpression="company">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/Organisation/EmployeeIDFormat.aspx?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("company")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Formats" ItemStyle-Width="100px" HeaderText="ID Formats"
                            SortExpression="Formats" />
                        <asp:BoundField DataField="Prefix" ItemStyle-Width="100px" HeaderText="Prefix"
                            SortExpression="Prefix" />
                        <asp:BoundField DataField="Digits" ItemStyle-Width="100px" HeaderText="Number of Digits"
                            DataFormatString="{0:d}" ItemStyle-HorizontalAlign="Right" SortExpression="Digits" />
