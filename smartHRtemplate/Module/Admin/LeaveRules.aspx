<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="LeaveRules.aspx.vb"
    Inherits="GOSHRM.LeaveRules" EnableEventValidation="false" Debug="true" %>
            ...
            <div class="search-box-wrapper col-sm-6 col-md-3 col-xs-12 form-group pull-right">                        
                 ...
                 <div class="col-md-3 col-sm-6 col-xs-12 form-group pull-right">                                  
                    <button id="btnUploadFile" type="button" runat="server" class="fa fa-upload btn btn-default btn-sm"
                        onserverclick="btnUpload_Click" data-toggle="tooltip" data-original-title="CSV File: Name, LeaveType, JobType, LeaveDays, MinService, MaxService, LeaveAccrued {Yes/No}, CarriedForward {Yes/No}, PercentCarriedForward(%), CarriedForwardPeriod" style="margin-right:10px;margin-left:10px;height:35px"></button>
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" ItemStyle-VerticalAlign="Top" SortExpression="rulename"
                            ItemStyle-Font-Bold="true">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/LeaveRuleupdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("rulename")%>' />
                        ...
                        <asp:BoundField DataField="Leaves Per Year (Days)" HeaderText="Leaves (Days)" ItemStyle-HorizontalAlign="Right" DataFormatString="{0:d}" SortExpression="Leaves Per Year (Days)" />
                        <asp:BoundField DataField="minmthservice" HeaderText="Min. Months Service" SortExpression="minmthservice" ItemStyle-HorizontalAlign="Right"/>
                        <asp:BoundField DataField="maxmthservice" HeaderText="Max. Months Service" SortExpression="maxmthservice" ItemStyle-HorizontalAlign="Right"/>
                    </Columns>
