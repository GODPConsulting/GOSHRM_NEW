...
Public Class Certifications
    ...
    Dim Pages As String = "Certification"
    Private Function LoadData() As DataTable
        Dim dt As New DataTable
        If Session("View") = "All" Then
            dt = Process.GetData("Certifications_get_all")
        ElseIf Session("View") = "Find" Then
            dt = Process.SearchData("Certifications_search", search.Value.Trim)
        End If
        pagetitle.InnerText = "Certifications (" & FormatNumber(dt.Rows.Count.ToString, 0) & ")"
        Return dt
    End Function
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            If Process.AuthenAction(Session("role"), AuthenCode, "Create") = False Then
                ...
                Exit Sub
            End If
            Response.Redirect("~/Module/Admin/CertificationsUpdate.aspx", True)
            ...
            If confirmValue = "Yes" Then
                ...
                For Each row As GridViewRow In GridVwHeaderChckbox.Rows
                    ...
                    If cb IsNot Nothing AndAlso cb.Checked Then
                        ...
                        ' "Delete" the row
                        SqlHelper.ExecuteNonQuery(WebConfig.ConnectionString, "Certifications_delete", ID)
                    End If
                Next
    ...
    Protected Sub btnExport_Click(sender As Object, e As EventArgs)
        Try
            If Process.ExportExcel(LoadData, "") = False Then
    ...
    Protected Sub btnUpload_Click(sender As Object, e As EventArgs)
        Try
            ...
            If Not file1.PostedFile Is Nothing Then
                ...
                If Process.Import(csvPath, "certifications_upload", Pages) = True Then
