...
<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="RewardTable.aspx.vb"
    Inherits="GOSHRM.RewardTable" EnableEventValidation="false" Debug="true" %>
                        ...
                        <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Employee" ItemStyle-Font-Bold="true" SortExpression="name">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#String.Format("~/Module/Admin/reward?id={0}",
                                 HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("bonusReward")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
