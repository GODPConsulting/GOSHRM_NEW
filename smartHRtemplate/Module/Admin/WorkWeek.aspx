<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup ="true" CodeBehind="WorkWeek.aspx.vb" Inherits="GOSHRM.WorkWeek" EnableEventValidation="false" Debug="true"%>
       ...
       <div class="panel panel-success">
            ...
            <div class="search-box-wrapper col-sm-6 col-md-4 col-xs-12 form-group pull-right">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12 pull-right">
                     <button id="btnLink" type="button" runat="server" class="btn btn-primary btn-success" onserverclick="lnkweekdays_Click"
                        style="height: 35px; width: 100%">
                        Work by Grade</button>
                </div> 
    </div>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Day"  ItemStyle-Font-Bold="true"
                            SortExpression="day">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/WorkWeekUpdate?id={0}",
