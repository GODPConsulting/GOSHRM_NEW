...
<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="RewardJobGradeUpdate.aspx.vb" Inherits="GOSHRM.RewardJobGradeUpdate" EnableEventValidation="false" Debug="true" %>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        ...
                                        <telerik:RadDropDownList ID="RadDropDownList3" runat="server" DefaultMessage="-- Select --"
