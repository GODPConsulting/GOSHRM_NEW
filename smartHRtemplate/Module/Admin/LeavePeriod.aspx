<%@ Page Language="vb" MasterPageFile="~/smartHR.Master" AutoEventWireup="true" CodeBehind="LeavePeriod.aspx.vb"
    Inherits="GOSHRM.LeavePeriod" EnableEventValidation="false" Debug="true" %>
                ...
                <asp:GridView ID="GridVwHeaderChckbox" runat="server" OnSorting="SortRecords" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Name" ItemStyle-VerticalAlign="Top" SortExpression="name"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# string.Format("~/Module/Admin/LeavePeriodUpdate?id={0}",
                     HttpUtility.UrlEncode(Eval("id").ToString())) %>' Text='<%# Eval("name")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="Period Start" HeaderText="Period Start" SortExpression="Period Start" DataFormatString="{0:dd, MMM yyyy}" />
                        <asp:BoundField DataField="Period End" HeaderText="Period End" SortExpression="Period End" DataFormatString="{0:dd, MMM yyyy}"/>
                    </Columns>
