<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DualAuthentication.aspx.vb" Inherits="GOSHRM.DualAuthentication" %>
                ...
                <div class="account-box">
                    <div class="account-wrapper">
                        ...
                        <form id="frmlogin" runat="server">
                            <h3>Enter code</h3>
                            <br />
                            <label style="font-size:13px">We have sent the code to</label><label style="color:transparent">''</label><label id="sentto" runat="server" style="font-size:13px"></label>
                            <label id="medium" runat="server"></label>
                            <br />
                            <label style="font-size:13px">Please enter the code to sign in</label>
                            <br />
                            <br />

                            <div class="form-group has-feedback">
                                <input id="txtcode" name="code" type="text" class="form-control" placeholder="Code" />
                                <span class="glyphicon form-control-feedback"></span>
                            </div>
                            <div class="text-center" style="height: 20px">
                            </div>
                            <div class="form-group text-center">
                                <button id="btnLogin" runat="server" onserverclick="btnLogin_Click" class="btn btn-primary btn-success btn-block btn-flat btn-lg"
                                    type="submit">
                                    Verify</button>
                            </div>
                            <div></div>
