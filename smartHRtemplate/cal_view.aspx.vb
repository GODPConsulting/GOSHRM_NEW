...
Public Class cal_view
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Me.IsPostBack Then
                ...
                Dim strtest As DataSet = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Calendar_Event_Get_All", Session("UserEmpID"), Date.Now)
                ...
                data = jsonSerializer.Serialize(listevents)
    ...
    'Public Sub get_events()
    '    Try
    '        Dim listevents As List(Of cal_events) = New List(Of cal_events)()
    '        Dim strtest As DataSet = SqlHelper.ExecuteDataset(WebConfig.ConnectionString, "Calendar_Event_Get_All")
    '        If strtest.Tables(0).Rows.Count > 0 Then
    '            Dim c As Integer = strtest.Tables(0).Rows.Count
    '            If c > 0 Then
    '                For i As Integer = 0 To c - 1
