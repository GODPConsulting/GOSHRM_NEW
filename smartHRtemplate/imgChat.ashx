<%@ WebHandler Language="C#" Class="imgChat" %>

using System;
using System.Web;

public class imgChat : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            selcmd = new System.Data.SqlClient.SqlCommand("select isnull(imgfile,'') imgfile, isnull(imgtype,'') imgtype from Emp_PersonalDetail where empid='" + context.Request.QueryString["imgid"] + "'", conn);
          conn.Open();
